...
[eva] constantFolding.c:24: starting to merge loop iterations
[eva] using specification for function printf_va_6
[eva:summary] ====== ANALYSIS SUMMARY ======
  ----------------------------------------------------------------------------
  6 functions analyzed (out of 6): 100% coverage.
  In these functions, 32 statements reached (out of 33): 96% coverage.
  ----------------------------------------------------------------------------
...
void constant_folding_in_loop_example(void)
{
  int i = 0;
  while (i < 5) {
    {
